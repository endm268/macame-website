...
const Services = () => {
        ...
        entries.forEach((entry) => {
          ...
          if (entry.isIntersecting) {
            setVisibleImages((prev) => [
              ...new Set([...prev, Number(targetElement.dataset.index)]),
            ]);
          }
        });
      },
  ...
  return (
    <section
      id="services"
      ref={sectionRef}
      className="bg-white py-12 px-4 sm:px-6 md:px-10 lg:px-12 text-gray-800"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <motion.h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-myColorRed">
            خدماتنا
          </motion.h2>
          <motion.p className="mt-2 text-sm sm:text-base md:text-lg text-gray-600">
        ...
        >
          {servicesData.map((service, index) => (
            ...
            >
              ...
              <div
                className="w-full h-[200px] relative overflow-hidden rounded-sm service-image"
                data-index={index}
              >
              ...
              {/* Service Title */}
              <h3 className="text-base sm:text-lg font-semibold text-myColorRed">
                {service.title}
              </h3>
              {/* Service Description */}
